...
<body class="bg-amber-100"> 
    ...
    <div id="myModal" class="modal hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                ...
                <p class="text-center">Tu amigo se ha registrado con éxito</p>
        ...
        <div class="md:container md:mx-auto md:w-5/12 md:max-w-screen-md py-10 sm:py-8">
          <div class=" p-10 rounded shadow-md w-full bg-[#FDFCF8] ">
                ...
                <form method="post" action="{{ route('registrar-mascota') }}" class="relative z-10" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <button id="registro" onclick="validarCampos()"  type="submit" class="font-sans-serif text-white px-8 py-2 mx-auto rounded-full focus:outline-none focus:ring focus:border-blue-300 bg-[#B1796C] font-bold">Registro</button>
                        ...
                        <div class="flex justify-between items-center mb-4">
                <button id="actualizar" onclick="redirigirAPhp()" type="" class="font-sans-serif text-white px-9 py-2 mx-auto rounded-full focus:outline-none focus:ring focus:border-blue-300 bg-[#35312E] font-bold">Actualizar</button>
                        </div>
