...
<body>
  ...
  <div class="flex flex-col justify-center items-center w-full h-full ">
    <table class="border-collapse w-4/5 my-10 h-1/2 bg-[#fdecdd] table-fixed">
      <thead>
        <tr class="text-center ">
          <th class="border border-red-500 max-md:text-sm p-2">Nombre de la mascota</th>
          <th class="border border-red-500 max-md:text-sm p-2">Nombre de la vacuna</th>
          <th class="border border-red-500 max-md:text-sm p-2">Fecha de aplicación</th>
          <th class="border border-red-500 max-md:text-sm p-2">Primera dosis</th>
          <th class="border border-red-500 max-md:text-sm p-2">Segunda dosis</th>
          <th class="border border-red-500 max-md:text-sm p-2">Autorización</th>
        </tr>
      </thead>
      <tbody>
        <tr class="text-center">
