...
<body>
    ...
    <div class="bg-[#ffe248] w-full h-16 flex justify-center items-center ">
        <h1 style="font-family: 'Vibur', cursive;" class="text-4xl text-white">Perfil del Gato</h1>
    </div>
    <div class="h-screen  w-full bg-no-repeat bg-cover  bg-center flex flex-col justify-center items-center"
        ...
        <div class=" w-4/5 h-full  bg-[#ffe248]/50 my-4">
            <div class="flex flex-row m-10 w-full h-full max-md:flex-col justify-center items-start">
                <div class="mr-4 w-1/3 h-1/2 max-md:m-0  flex max-md:justify-center max-md:items-center max-md:flex-col">
                    <img src="Recursos/Gato.jpeg" alt="" class="">
                </div>
                <form action="" method="post" class="ml-4 w-1/2 max-md:w-full max-md:flex max-md:flex-col max-md:justify-center ">
                    <div class="flex flex-col w-1/2 mb-4">
                        ...
                        <input type="text" name="nombre" id="nombre" style="font-family: 'Wendy One', sans-serif"
                            class="rounded-full bg-[#ffe769] px-4 h-8 text-md" oninput="validarNumero()">
                    ...
                    <div class="flex flex-col w-1/2 mb-4">
                        ...
                        <input type="text" name="raza" id="raza" style="font-family: 'Wendy One', sans-serif"
                            class="rounded-full bg-[#ffe769] px-4 h-8 text-md" oninput="validarNumero2()">
                    ...
                    <div class="flex flex-col w-1/2 mb-4">
                        ...
                        <input type="date" name="dateNacmiento" id="dateNacmiento"  class="rounded-full bg-[#ffe769] px-4 h-8 text-md" value="">
