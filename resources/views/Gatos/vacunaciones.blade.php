    ...
    <table class="border-collapse w-3/5 my-10 h-1/2 bg-[#fdecdd] table-fixed">
      <thead>
        <tr class="text-center ">
          ...
          <th class="border border-red-500 max-md:text-sm p-2">Etiqueta</th>
          <th class="border border-red-500 max-md:text-sm p-2">Vacuna</th>
          <th class="border border-red-500 max-md:text-sm p-2">Fecha Próx. Vacuna</th>
