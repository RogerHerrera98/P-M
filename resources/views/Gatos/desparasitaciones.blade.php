...
<body>
  ...
  <div class="w-full bg-[#c93a3a] flex justify-center items-center h-20">
    <h1 class="text-white text-4xl py-2" style="font-family: 'Vibur', cursive;">Desparasitaciones</h1>
  </div>
  <div class="flex flex-col justify-center items-center w-full h-screen bg-no-repeat bg-cover bg-center" style="background-image: url('Recursos/Fondo_Cli.png');">
    <table class="border-collapse w-3/5 my-10 h-1/2 bg-[#fdecdd] table-fixed">
      <thead>
        <tr class="text-center ">
          <th class="border border-red-500 max-md:text-sm p-2">Fecha</th>
          <th class="border border-red-500 max-md:text-sm p-2">Diagnostico</th>
          <th class="border border-red-500 max-md:text-sm p-2">Desparasitante</th>
          <th class="border border-red-500 max-md:text-sm p-2">Próxima desparatisitacion</th>
          <th class="border border-red-500 max-md:text-sm p-2">Firma M.V.Z</th>
