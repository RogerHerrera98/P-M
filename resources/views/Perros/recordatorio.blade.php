...
<nav class="bg-[#E3EEFF] h-20 w-full flex flex-row justify-between items-center">
  ...
  <div class="flex flex-col justify-center items-center w-full h-screen bg-no-repeat bg-cover bg-center" style="background-image: url('Recursos/Fondo_Cli.png');">
    <table class="border-collapse w-1/3 h-1/2 bg-[#e1ffb0] table-fixed">
      <thead>
        <tr class="text-center ">
          <th class="border border-green-500 max-md:text-sm p-2">Fecha</th>
          <th class="border border-green-500 max-md:text-sm p-2">Hora</th>
          <th class="border border-green-500 max-md:text-sm p-2">Motivo</th>
