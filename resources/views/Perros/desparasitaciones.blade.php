    ...
    <table class="border-collapse w-3/5 my-10 h-1/2 bg-[#e1ffb0]table-fixed">
      <thead>
        <tr class="text-center ">
          ...
          <th class="border border-green-500 max-md:text-sm p-2">Diagnostico</th>
          <th class="border border-green-500 max-md:text-sm p-2">Desparasitante</th>
          <th class="border border-green-500 max-md:text-sm p-2">Próxima desparatisitacion</th>
